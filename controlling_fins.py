...
class ActiveCanardsRocket(Rocket):
    ...
    def add_afs_canards(
        ...
        _controller = _Controller(
            ...
            controller_function=self.canard_controller_function,
    ...
    def canard_controller_function(
        ...
        canards = aerodynamic_surfaces[2]
        ...
        canard_deflection = pd_angle(
            env.density(altitude_AGL),
            total_velocity, 
            canards.Af, 
            canard_deflection, 
            # rocket.get_aerodynamic_coefficients(time=time)['Canards'],
            None,
            pitch_rate,
            roll_rate, 
            yaw_rate,
